...
public class CustomEndlessRecyclerView extends RecyclerView {
    ...
    public CustomEndlessRecyclerView(Context context) {
        this(context, null);
    }

    public CustomEndlessRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomEndlessRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
